...
public class AllQuery: GraphQLQuery {
  public static let operationName: String = "all"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query all { Page(page: 0, perPage: 10) { __typename media(type: ANIME, status: RELEASING) { __typename id coverImage { __typename large medium color } title { __typename userPreferred } episodes nextAiringEpisode { __typename airingAt } } } }"#
    ))
